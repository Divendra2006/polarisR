...
<img src="../man/figures/logo.png" align="right" height="80" style="border:0;" />
...
2. **Dataset Visualization** - Apply NLDR methods (t-SNE/UMAP) with parameter configuration and visualization
...
5. **Method Comparison** - Compare different NLDR configurations and results
...
The **Dataset Visualization** tab is where the main NLDR analysis happens. You can choose between t-SNE and UMAP, configure their parameters, and visualize the results.
...
*   **Select Tour Display:** Choose from three types of dynamic tours:
    ...
    *   **Sage:** A density-based plot that highlights areas of high data concentration.
    *   **Slice:** A plot that shows a slice of the high-dimensional space.
*   **Tour Options:**
    *   **Show Axes:** Toggle the visibility of the axes in the tour plot.
    *   **Point Opacity (Alpha):** Adjust the transparency of the points.
    *   **Gamma (for Sage):** Control the smoothing parameter for the sage plot.
...
*   **Analysis Results:** The results of the analysis are presented in several tabs:
    ...
    *   **Optimization Table:** A table with the detailed results of the binwidth optimization.
    ...
    *   **Model Fit:** A visualization that shows the quality of the model fit, highlighting areas of high and low prediction error.
...
The **Method Comparison** tab allows you to compare the results of different NLDR analyses. You can compare different methods (t-SNE vs. UMAP) or the same method with different parameters.
